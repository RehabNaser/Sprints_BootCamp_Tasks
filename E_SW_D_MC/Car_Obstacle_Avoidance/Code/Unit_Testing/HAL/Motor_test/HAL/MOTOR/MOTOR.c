...
ERROR_STATE_t MOTOR_init(void) {
   ...
   /*SETTING MOTOR1 DIR PINS TO OUTPUT*/
	DIO_SetPinDirection(gastr_Motor_Config[MOTOR1].u8_MotorPortEnable, gastr_Motor_Config[MOTOR1].u8_MotorPinEnable, PIN_OUTPUT);
	...
	DIO_SetPinDirection(gastr_Motor_Config[MOTOR2].u8_MotorPortEnable, gastr_Motor_Config[MOTOR2].u8_MotorPinEnable, PIN_OUTPUT);
